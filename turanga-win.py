...
class TurangaFormatFile:
	...
	def w(self, content):
		...
		print(" [i] " + self.filename + ".crg saved :)")
		cf.close()
		...
		for tbyte in r:
			...
			if tbytecount == 3:
				...
				tbytecount = 0
			      ...
			      print " [!] Error al procesar la llave, quiza la clave sea incorrecta."
			      sys.exit()
			    
			tbytecount = tbytecount + 1
		
		print("\n [*] Turanga Key File - version " + version + "")
...
class TurangaImageCryp:
	...
	def cryp(self):
		...
		print(" [*] Image for crypt: " + self.pathInput + "")
		...
		for x in range(0, self.imageObject.size[0]):
			for y in range(0, self.imageObject.size[1]):
				...
				for color in RGB:
					...
					if kc <= 19:
						print ("     color : " + str(color) + " key : " + str(a) + " inv : " + str(inv).zfill(3) + " r : " + str(result).zfill(3))
		...
		print ("\n [*] Done! ")
		print (" [i] " + str(bytesCount) + " bytes crypted in " + self.pathOutput + ".png\n")
		
	def decryp(self):
		# load the key file
		filename = self.pathInput.split(".")
		self.turangafile = TurangaFormatFile(filename[0], self.key)
		print(" [i] Loading key file(" + filename[0] + ".crg) ...")
		...
		print ("\n [*] Done! ")
		print (" [i] " + str(byteCount) + " bytes decrypted in " + self.pathOutput + ".png\n")
...
|__  $$__/                                                        
   ...
   | $$| $$  | $$| $$      /$$__  $$| $$  | $$| $$  | $$ /$$__  $$
   | $$|  $$$$$$/| $$     |  $$$$$$$| $$  | $$|  $$$$$$$|  $$$$$$$
   |__/ \______/ |__/      \_______/|__/  |__/ \____  $$ \_______/
                                               /$$  \ $$          
                                              |  $$$$$$/          
                                               \______/ 
		"""
...
|_|  |_||  |  ||    / |     ||  |  ||  |  ||     |
  |  |  |  :  ||    \ |  _  ||  |  ||  |_ ||  _  |
  |  |  |     ||  .  \|  |  ||  |  ||     ||  |  |
  |__|   \__,_||__|\_||__|__||__|__||___,_||__|__|
		"""
	elif logo == 3:
		print"""
...
def show_help():
	...
	print ('\n   Usage:')
	print ('   =========================================================================================')
	print ('   Hide   a File in   a Image : <turaga> -es <FileToHide>    <Image>        <NameToOutput> ')
	print ('   Unhide a File from a Image : <turaga> -un <ImageWithData> <NameToOutput> ')
	print ('   Cryp   a TextFile          : <turaga> -ct <File>          <key> ')
	print ('   Decryp a TextFile          : <turaga> -dt <CrypedFile>    <key> ')
	print ('   Cryp   a Image             : <turaga> -ci <Image>         <NameToOutput> ')
	print ('   Decryp a Image             : <turaga> -di <CrypedImage>   <NameToOutput> ')
	print ('   Convert a file             : <turaga> -cv <File>          <NameToOutput> <type>')
	print ('   =========================================================================================\n')
	...
	print ('\n       Linux:')
	print ('                   ls *.jpg > img_list ')
	print ('       Windows:')
	print ('                   dir *.jpg>img_list.txt ')
	...
	print ('\n         <turanga> -ci --list img_list ')
	print ('                       ó')
	print ('         <turanga> -ci --list img_list.txt ')
